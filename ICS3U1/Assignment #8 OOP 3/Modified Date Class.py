...
Prompt = StringVar()
Prompt.set(value="Please refer to console to see overloaded operators.")
...
#   __sub__: Returns the amount of days between the current date and another date.
#   __gt__: Returns if the date is greater than another date.
#   __lt__: Returns if the date is less than another date.
#   __ge__: Returns if the date is greater than or equal to another date.
#   __le__: Returns if the date is less than or equal to another date.
#   __eq__: Returns if the date is equal to another date.
#   __ne__: Returns if the date is not equal to another date.
#   __add__: Returns a date that is ahead of the greater date, by the amount equal to the difference of the dates.
class Date:
    # Constructor
    ...
    def getDate(self):
        ...
        print("You are now entering the month of the date.")
        self.month = getPositiveInteger(1,12)
        print("You are now entering the year of the date.")
    ...
    # __sub__
    # Purpose: To obtain the amount of days between two dates.
    # Parameters: The given second date.
    def __sub__(self,secondDate):
        ...
        if self > secondDate:
            ...
            lesser = secondDate
        totalDays = 0
        for count in range(lesser.year,greater.year):
            yearFraction = Date(1,1,count)
            if yearFraction.returnLeapYear():
                totalDays = totalDays + 366
            else:
                totalDays = totalDays + 365
        for count in range(lesser.month,greater.month):
            monthFraction = Date(1,count,greater.year)
            totalDays = totalDays + monthFraction.ReturnMaxDay()
        totalDays = totalDays + (greater.day - lesser.day)
        return totalDays
            
            
    # __gt__
    # Purpose: To return if one date is greater than another date.
    # Parameters: The given second date.
    ...
    # __lt__
    # Purpose: To return if one date is less than another date.
    # Parameters: The given second date.
    ...
    # __ge__
    # Purpose: To return if one date is greater than or equal to another date.
    # Parameters: The given second date.
    ...
    # __le__
    # Purpose: To return if one date is less than or equal to another date.
    # Parameters: The given second date.
    def __le__(self,secondDate):
        ...
        return le
    # __eq__
    # Purpose: To return if one date is equal to another date.
    # Parameters: The given second date.
    def __eq__(self,secondDate):
        eq = False
        if self.day == secondDate.day and self.month == secondDate.month and self.year == secondDate.year:
            eq = True
        return eq
    
    # __ne__
    # Purpose: To return if one date is not equal to another date.
    # Parameters: The given second date.
    def __ne__(self,secondDate):
        ne = False
        if (self == secondDate) == False:
            ne = True
        return ne
    
    # __add__
    # Purpose: To return the sum of two given dates.
    # Parameters: The given second date
    def __add__(self,secondDate):
        greaterDate = Date()
        daysInBetween = self - secondDate
        if self > secondDate:
            greaterDate = self
        else:
            greaterDate = secondDate
        greaterDate.day = greaterDate.day + daysInBetween
        while greaterDate.day > greaterDate.ReturnMaxDay():
            greaterDate.day = greaterDate.day - greaterDate.ReturnMaxDay()
            greaterDate.month = greaterDate.month + 1
            if greaterDate.month > 12:
                greaterDate.month = 1
                greaterDate.year = greaterDate.year + 1
        return greaterDate
...
btnCalculate = Button(root,width=10,text="Calculate!",height=2,font=("Arial","20","bold"),command=lambda:calculate(Day.get(),Month.get(),Year.get()),state="disabled")
...
#CONSOLE DATE TESTER: TESTING OVERLOADED OPERATORS#
again = "Y"
while again == "Y" or again == "y":
    print("You will now enter your first date.")
    print()
    firstDate = Date()
    firstDate.getDate()
    while not(firstDate.calcValid()):
        print("Your current date configuration is not correct for your first date.")
        firstDate.getDate()
    print()
    print("Your first date is: " + str(firstDate))
    print()
    print("You will now enter your second date.")
    print()
    secondDate = Date()
    secondDate.getDate()
    while not(secondDate.calcValid()):
        print("Your current date configuration is not correct for your first date.")
        secondDate.getDate()
    print()
    print("Your second date is : " + str(secondDate))
    print()
    print()
    print()
    print("There are " + str(firstDate-secondDate) + " days between your two dates.")
    print("If you add the dates, you will obtain " + str(firstDate+secondDate) + "!")
    if firstDate > secondDate:
        print("Your first date is greater than your second date!")
    elif firstDate < secondDate:
        print("Your first date is less than your second date!")
    elif firstDate == secondDate:
        print("Your first date is equal to your second date!")
    if firstDate >= secondDate:
        print("Your first date is greater than or equal to your second date!")
    if firstDate <= secondDate:
        print("Your first date is less than or equal to your second date!")
    if firstDate != secondDate:
        print("Your first date is not equal to your second date!")
        
    again = input("Would you like to enter another date? Y/N: ")
    while not((again != "y") or (again != "n") or (again != "Y") or (again != "N")):
        again = input("Please re enter if you would like to enter another date. (Y/N): ")

print("Thanks for testing your two dates through the console!")
